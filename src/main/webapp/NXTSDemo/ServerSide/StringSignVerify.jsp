...
<%@ page import="java.io.*, java.util.*, java.security.*, java.lang.*" %>
...
<SCRIPT language="javascript">
	...
	function plainTextchk()
	{
		...
		document.myform.action="StringSignVerify.jsp";
...
<table border="2" width="670" cellpadding="5" cellspacing="0" bordercolor="#E0E0E0" bgcolor="#F0F0F0">
  <tr>
    <td align="left">
      <textarea name="veryfi_msg" rows="6" cols="90" ><%= Strveryfi_msg %></textarea>
    </td>
</tr>
  <tr>
    <td align="right">
      <INPUT TYPE="button" Value="화면 지우기" onClick="location.href='./StringSignVerify.html'">
    </td>
  </tr>
</table>
...
<%
	...
	{
%>	
  <tr><td align="left"><b>인증서DN : <%= CertDn[i] %></b></td></tr>
<%  } %>
</table>
<%
